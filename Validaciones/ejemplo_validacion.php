            ...
            <div class="col-md-6">
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    <div class="form-group">
                        ...
                        <input name="nombre" type="text" class="form-control" value="<?php if (!empty($_POST["nombre"])) { echo $nombre; }else {echo "";}?>">
                        <span class="error invalid-feedback"> <?php echo $nombreErr;?></span>
                    </div>
                    <br><br>
                    <div class="form-group">
                        <label class="col-form-label"><span class="error">* </span>Email</label>
                        <input name="email" type="text" class="form-control" value="<?php if (!empty($_POST["email"])) { echo $email; }else {echo "";}?>">
