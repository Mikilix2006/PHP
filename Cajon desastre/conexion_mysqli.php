...
try {
    ...
    $mysqli->query("INSERT INTO usuarios(user, password, rol) VALUES ('hermenegildo', 'hermenegildo123', 0)");
    ...
    $mysqli->query("UPDATE  usuarios SET password = 'gabarrindo123' WHERE user LIKE 'gabarrindo'");
